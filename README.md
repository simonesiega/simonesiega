...
**[codex-limits](https://github.com/simonesiega/codex-limits)** — <samp>TypeScript · Bun · CLI/TUI · Agent Integrations · [OpenAI Codex discussion](https://github.com/openai/codex/discussions/44641) · [npm](https://www.npmjs.com/package/@simonesiega/codex-limits) · <!-- codex-downloads:start -->2.2K+ downloads<!-- codex-downloads:end --></samp>
